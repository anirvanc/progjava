...
<div class="container">
    ...
    <div class="content">
        <div class="page-header">
            <h1><c:choose><c:when test="${empty depratment.nodeId}">Add</c:when><c:otherwise>Edit</c:otherwise></c:choose> Department</h1>
        </div>

        <!-- Add/Edit Department form
              ================================================== -->
        <form:form commandName="department" action="/departments/save.html" method="post" cssClass="form-horizontal">
            <form:hidden path="nodeId"/>
            <fieldset>
                <div class="control-group">
                    <label for="name" class="control-label">Name</label>
                    <div class="controls">
                        <form:input path="name" cssClass="input-xlarge" size="30"/>
                    </div>
                </div>
            </fieldset>
            <fieldset>
